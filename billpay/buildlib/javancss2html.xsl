...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" version="1.0">
  ...
  <xsl:template match="/">
    <html>
      ...
      <body>
        <h1>
        <a name="top">JavaNCSS Analysis of <xsl:value-of select="$project"/></a>
        </h1>
		<p align="right">Run with <a href="http://www.kclee.com/clemens/java/javancss/">JavaNCSS</a> on <xsl:value-of select="$today"/></p>
        <hr size="2"/>
        <xsl:apply-templates/>
      </body>
    </html>
